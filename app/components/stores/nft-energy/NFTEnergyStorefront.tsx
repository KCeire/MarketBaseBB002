          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6 hover:border-white/20 transition-all">
              <div className="text-center space-y-3">
                ...
                <h3 className="text-white font-semibold">Real Product</h3>
                <p className="text-white/60 text-sm leading-relaxed">Physical energy drinks on shelves today</p>
              </div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6 hover:border-white/20 transition-all">
              <div className="text-center space-y-3">
                ...
                <h3 className="text-white font-semibold">Web3 Native</h3>
                <p className="text-white/60 text-sm leading-relaxed">NFT collection coming Winter 2025</p>
              </div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6 hover:border-white/20 transition-all">
              <div className="text-center space-y-3">
                ...
                <h3 className="text-white font-semibold">Community First</h3>
                <p className="text-white/60 text-sm leading-relaxed">Built by and for the Web3 community</p>
              </div>
            </div>
          </div>

          {/* Trust Indicators */}
          <div className="text-center mb-12 pt-8 border-t border-white/10">
            <p className="text-white/50 text-sm mb-4">Trusted by Web3 communities</p>
            <div className="flex justify-center items-center space-x-8 opacity-60">
              <div className="text-white/60 text-xs font-medium">BASE CHAIN</div>
              <div className="w-1 h-1 bg-white/40 rounded-full"></div>
              <div className="text-white/60 text-xs font-medium">USDC PAYMENTS</div>
              <div className="w-1 h-1 bg-white/40 rounded-full"></div>
              <div className="text-white/60 text-xs font-medium">WEB3 NATIVE</div>
            </div>
          </div>
