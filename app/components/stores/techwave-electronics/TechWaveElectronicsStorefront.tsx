        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="space-y-1">
            ...
            <p className="text-xs text-blue-100 max-w-md mx-auto">
              Cutting-edge gadgets and electronics at competitive prices.
            </p>
            <div className="flex justify-center space-x-3 text-blue-200">
              ...
              {filteredProducts.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {filteredProducts.map((product) => {
                    ...
                    <div
                      key={product.id}
                      className="bg-white/10 backdrop-blur-md rounded-xl border border-blue-200/20 overflow-hidden hover:bg-white/20 transition-all duration-200 group flex flex-col"
                    >
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        <div className="flex-1">
                          ...
                          <p className="text-blue-100 text-sm leading-relaxed line-clamp-3 mb-4">{stripHtmlTags(product.description)}</p>
                        ...
                        <div className="space-y-3 mt-auto">
                          <div className="space-y-1">
                            <div className="flex items-center space-x-2">
                              ...
                              {totalComparePrice && (
                                <span className="text-blue-300 line-through text-lg">${totalComparePrice}</span>
                              )}
                            </div>
                            <div className="text-xs text-blue-200">
                          ...
                          <div className="space-y-2">
                            ...
                            <Button
                              ...
                              className="w-full border-blue-300/30 text-blue-200 hover:bg-blue-500/10"
                          ...
                          <div className="border-t border-blue-200/20 pt-3">
                            <ShareButton
                              product={{
                                id: product.id,
                                title: product.title,
      ...
      <footer className="py-12 px-4 bg-black/40 border-t border-blue-200/20">
        <div className="max-w-7xl mx-auto text-center">
          <div className="text-blue-200 space-y-2">
            <p>&copy; 2025 TechWave Electronics. All rights reserved.</p>
