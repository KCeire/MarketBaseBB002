...
export const Icon: React.FC<IconProps> = ({ name, size = 'md', className = '' }) => {
  ...
  const iconClass = `${sizes[size]} ${className}`;
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    'expand': (
      <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7V4a1 1 0 011-1h3M21 7V4a1 1 0 00-1-1h-3M21 17v3a1 1 0 01-1 1h-3M3 17v3a1 1 0 001 1h3M8 8l8 8M16 8l-8 8" />
      </svg>
    ),
    'discord': (
