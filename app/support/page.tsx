          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">lk@lkforge.xyx</p>
              </div>
            </button>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="border-b border-gray-100 pb-3">
              ...
              <p className="text-xs text-gray-600">Every user is automatically an affiliate. Share products and earn a commission on settled sales.</p>
            </div>
            <div className="border-b border-gray-100 pb-3">
